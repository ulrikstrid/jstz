import { Address, isAddress, Kv, TextEncoder, Contract } from "./jstz_api"
...
export type UpdateOperator = { operation: "add_operator" | "remove_operator", owner: Address, operator: Address, token_id : TokenId}
export function isUpdateOperator(argument: unknown): argument is UpdateOperator {
...
function operatorKey(owner: Address, operator: Address, token_id : TokenId): string {
